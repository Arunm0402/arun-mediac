<template>
    <div class="row justify-between items-center q-px-md q-py-xs">
      <div class="col-4">
        <p  @click="backtoHome" style="margin-bottom:0; cursor: pointer;"><q-icon style="margin-right:5px;" name="west" size="1.5em" />Workspace</p>
...
//   import SwitchModeHeader from 'src/components/Content/global/SwitchModeHeader.vue'
  ...
  export default defineComponent({
    ...
    setup() {
      ...
      const manageUsers = () => {
        void router.push('/manageusers')
      }
  const backtoHome = () => {
    void router.push('/assumAdmin')
  }
...
.logoDD.q-btn--outline:before {
    border: unset !important;
}
.q-item {
    padding: auto;
}
.logoDD .q-focus-helper {
